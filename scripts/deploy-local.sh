...
H3_VERIFIER=$(echo "$OUTPUT" | grep "H3_MEMBERSHIP_VERIFIER_ADDRESS=" | sed 's/.*=//')
...
sed -i '/^H3_MEMBERSHIP_VERIFIER_ADDRESS=/d' "$WEB_ENV"
...
H3_MEMBERSHIP_VERIFIER_ADDRESS=$H3_VERIFIER
EOF

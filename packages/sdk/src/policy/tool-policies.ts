...
export const TOOL_POLICIES: Record<string, ToolPolicy> = {
  ...
  // ─── person-mcp: MCP-only (no on-chain). Add as needed. ─────────────
  // Person-mcp tools are added here as we touch them. For now, a permissive
  // mcp-only default — they'll get explicit policies as the SDK grows.
}

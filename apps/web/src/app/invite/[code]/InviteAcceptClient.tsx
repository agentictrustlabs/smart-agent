...
export function InviteAcceptClient({ code, agentName, role }: InviteAcceptClientProps) {
  ...
  if (!ready) return <p style={{ marginTop: '1rem', color: '#8888a0' }}>Loading...</p>

  if (accepted) {
    return (
      <div style={{ marginTop: '1.5rem' }}>
        <p style={{ color: '#22c55e', fontWeight: 600 }}>Accepted! You are now a {role} of {agentName}.</p>
        <p style={{ color: '#8888a0', fontSize: '0.85rem' }}>Redirecting to dashboard...</p>
      </div>
    )
  }
  ...
  if (!authenticated) {
    return (
      <div style={{ marginTop: '1.5rem' }}>
        <p style={{ color: '#8888a0', marginBottom: '1rem' }}>Connect your wallet to accept this invite.</p>
  ...
  return (
    <div style={{ marginTop: '1.5rem' }}>
      <p style={{ color: '#8888a0', marginBottom: '0.5rem' }}>

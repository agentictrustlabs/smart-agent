...
export default async function StewardPage() {
  ...
  if (isCIL) {
    ...
    // Proposals moved to org-mcp. Listing across all orgs requires per-org
    // delegation tokens — until those flows ship, the steward page renders
    // an empty list. On-chain governance state remains canonical.

      ...
      <section data-component="graph-section">
        ...
        {governanceInitialized ? (
            ...
            <div style={{ marginTop: '1.5rem', padding: '1rem', background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 'var(--radius-sm)' }}>
              ...
              {addMode === 'select' && (
                <div>
                  {availablePeople.length === 0 ? (
                    <p style={{ color: '#8888a0', fontSize: '0.85rem' }}>No available people to add. Use "By Address" or "Invite Link".</p>
                  ) : (
              ...
              {addMode === 'address' && (
                <div data-component="form-field">
                  ...
                  <p style={{ fontSize: '0.75rem', color: '#8888a0', margin: '0.25rem 0' }}>
              ...
              {addMode === 'invite' && (
                <div>
                  <p style={{ color: '#8888a0', fontSize: '0.85rem', marginBottom: '0.75rem' }}>
                  ...
                  {inviteLink && (
                    <div style={{ marginTop: '0.75rem', padding: '0.75rem', background: 'var(--bg-card)', border: '1px solid var(--accent)', borderRadius: '8px' }}>
                      <label style={{ fontSize: '0.75rem', color: '#8888a0' }}>Share this link (expires in 7 days)</label>
          ...
          <form onSubmit={handleInitialize} data-component="deploy-form">
            <p style={{ color: '#8888a0', marginBottom: '1rem' }}>

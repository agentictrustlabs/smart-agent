  ...
  return (
    <div data-page="tee-validation">
      ...
      <div data-component="protocol-info">
        ...
        <p style={{ fontSize: '0.85rem', color: '#8888a0', lineHeight: 1.6 }}>
            ...
            <tbody>
              {teeVerifiers.map((v) => (
                <tr key={v.address}>
                  ...
                  <td style={{ fontSize: '0.8rem', color: '#8888a0' }}>{v.description}</td>
      ...
      <section data-component="graph-section">
        ...
        <div style={{ fontSize: '0.85rem', color: '#8888a0', lineHeight: 1.7 }}>

...
export default async function EntitlementDetailPage({ params }: {
  ...
  const holderOutcomeRow: any = null  // outcomes table dropped — empty result preserves downstream type
  const providerOutcomeRow: any = null  // outcomes table dropped — empty result preserves downstream type

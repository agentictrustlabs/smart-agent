...
import {
  ...
  TYPE_PERSON, TYPE_ORGANIZATION, TYPE_AI_AGENT, TYPE_TREASURY_AGENT, TYPE_POOL_AGENT,
...
export interface AgentMetadata {
  ...
  nameLabel: string
  agentType: 'person' | 'org' | 'ai' | 'treasury' | 'pool' | 'unknown'
...
const TYPE_MAP: Record<string, 'person' | 'org' | 'ai' | 'treasury' | 'pool'> = {
  [TYPE_PERSON]: 'person',
